...
Game.defs.freezing = {
    ...
    levels: [
        {cost:200, damage:1134, range: 3.5, rate:80},
        {cost:720, damage:3181, range: 3.7, rate:70},
        {cost:1120, damage:6790, range: 4, rate:70},
        {cost:1730, damage:13090, range: 4.2, rate:80},
        {cost:2680, damage:23988, range: 4.2, rate:60},
        {cost:4160, damage:42727, range: 4.2, rate:60},
        {cost:6445, damage:74858, range: 4.1, rate:60},
    ],
    atack: function(tower, creep) {
        Game.freezes.push(new Freeze(tower, creep));
    }
};
